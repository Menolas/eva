<article class="article">
	<div class="article__illustration">
		<picture>
			<source media="(min-width: 1440px)" srcset="img/iyengar-article-picture-desktop-wide.jpg">
			<source media="(min-width: 1024px)" srcset="img/iyengar-article-picture-desktop.jpg">
			<source media="(min-width: 375px)" srcset="img/iyengar-article-picture-mobile-wide.jpg">
			<img src="img/iyengar-article-picture-mobile.jpg" alt="Иллюстрация статьи">
		</picture>
	</div>
	<div class="article__text">
		<p>
			Вообще говоря, сам Айенгар никогда не называл сформированную им систему практики йогой Айенгара. Он всегда говорил, что занимается хатха-йогой, называя её наукой воли. Таким образом, если вы спросите: «Чем отличается хатха-йога от йоги Айенгара?», ответ, вероятнее всего, будет: «Ничем». И это чистая правда, если смотреть на суть. Однако личный опыт любого человека, даже самого просветлённого, не может не наложить отпечаток на традиции.
		</p>
	</div>
	<div class="clearfix"></div>
	<div class="article__text">
		<h2 class="article__secondary-title  title__secondary  <?=$text_color; ?>">Кому подходит йога Айенгара?</h2>
		<p>
			Многие наверняка задаются вопросом: <span class="article__mini-header  <?=$text_color; ?>">«Подходит ли йога Айенгара для начинающих»?</span>
