<article class="article">
	...
	<div class="article__text">
		...
		<span class="article__mini-header  <?=$text_color; ?>">В чем суть программы BODY PUMP?</span>
		<p>
		...
		<p>
			...
			Body Pump идеально подходит тем, кто хочет не просто уменьшить объемы тела, но и улучшить композицию тела и его рельеф.
		</p>
