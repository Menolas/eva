var reviews = [
  { 
    ...
    text: "Студия Ом Шанти имеет все условия для приятной практики, все преподаватели имеют свой неповторимый стиль и обаяние. Каждый класс здесь как семинар - вдохновляет и направляет. Спасибо за прекрасный опыт.",
